# Домашнее задание к уроку "Архитектура и серверная часть" (ProductStar)
...
2. **Инструкция:**
    ...
    * Установите зависимости проекта: `uv sync` (обратите внимание, что мы используем [uv](https://docs.astral.sh/uv/))
